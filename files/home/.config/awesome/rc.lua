...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        local wallpaper = "/home/tsutsumi/Dropbox/Wallpapers/denmark.jpg"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox = awful.wibar({
      position = "top",
      screen = s,
      height = s.workarea.height * 0.015
    })
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "d",
              function () awful.util.spawn("xrandr --output eDP-1 --auto --output DP-2 --off --output DP-1 --off") end,
              {description = "reset the displays"}),
    ...
    awful.key({}, "F12",
              ...
              {description = "suspend", group = "shortcuts"}),
    awful.key({}, "XF86MonBrightnessUp",
              function () awful.util.spawn("brightnessctl set 5%+") end,
              {description = "increase screen brightness", group = "shortcuts"}),
    ...
    awful.key({}, "XF86AudioLowerVolume",
              ...
              {description = "lower volume", group = "shortcuts"}),
    awful.key({}, "XF86AudioRaiseVolume",
              function () awful.util.spawn("pactl set-sink-volume @DEFAULT_SINK@ +10%") end,
              {description = "raise volume", group = "shortcuts"}),
    -- Mod1 == alt
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "m",
        ...
        {description = "(un)maximize icon: +", group = "client"}),
    awful.key({ modkey, "Control" }, "m",
        function (c)
            c.maximized_vertical = not c.maximized_vertical
            c:raise()
        end ,
        {description = "(un)maximize vertically (vertical arrows + airplanes)", group = "client"}),
    awful.key({ modkey, "Shift"   }, "m",
        function (c)
            c.maximized_horizontal = not c.maximized_horizontal
            c:raise()
        end ,
        {description = "(un)maximize horizontally (horizontal arrows + airplanes)", group = "client"})
)

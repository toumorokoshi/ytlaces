...
1. [Setup - The basics of getting started with laces](#setup)
    * [What laces affects](#what-laces-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with laces](#beginning-with-laces)
